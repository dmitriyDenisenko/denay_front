...
function AddSubjectToStudentPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        // Отправка запроса
        try {
            alert('Предмет студенту успешно добавлен.');
        } catch (error) {
            console.error('Ошибка:', error);
            alert('Ошибка при добавлении предмета студенту.');
        }
    };
    ...
    return (
        <div className={main_styles.welcome}>
            ...
            <div className="form-header">
                <p className={main_styles.text_create}>Добавить предмет студенту</p>
            </div>
...
export default AddSubjectToStudentPage;