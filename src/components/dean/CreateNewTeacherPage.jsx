...
function CreateNewTeacherPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        // Отправка запроса
        try {
            alert('Учетная запись преподователя успешно добавлена.');
        } catch (error) {
            console.error('Ошибка:', error);
            alert('Ошибка при добавлении учетной записи преподователя.');
        }
    };
    ...
    return (
        <div className={main_styles.welcome}>
            ...
            <div className="form-header">
                <p className={main_styles.text_create}>Добавить учетную запись Преподователя</p>
            </div>
...
export default CreateNewTeacherPage;